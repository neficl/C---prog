...
int main(void){
    ...
    scanf("%f", &nota1);                // Tal valor recido no corpo do programa em inter, depois se guarda em float e na função lemos em int, esperando novamente em float ...
    printf("Digite a segunda nota: ");  // Por conta disso esperos um valor inteiro mais proximo do resultado, não um inteiro com virgula.
    scanf("%f", &nota2);
