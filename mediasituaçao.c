...
int Situacao(float media){ // Acrescentamos nosso laco if que verifica a media e relaciona com a situacao conforme a nota do aluno.
    int situacao;          // Alem do mais remetemos o nosso laco para o switch case, pelas decricoes 1, 2 e 3.
    if (media >= 7){
        situacao = 1;
...
int main(void){
    ...
    printf("A situacao do aluno eh: ", situacao);
